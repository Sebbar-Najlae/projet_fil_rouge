class Email extends React.Component {
    ...
    render() {
      ...
      // let className = "";
      // className += this.props.email.date_expiration > date ? "text-danger" : "text-success";
        ...
        return (
                ...
                <tr>
              <td scope="row">{this.props.email.email}</td>
              <td>{this.props.email.subject}</td>
              <td>{this.props.email.body}</td>
              <td>{this.props.email.dateSend}</td>
              {/* <td className={className}>{this.props.email.etat}</td> */}
